		...
		<div class="row">
			<div class="col-md-6 col-md-offset-3">
				<div class="register-box">
					...
					<form action="Add2Servlet" method="get"
						onsubmit="return checkSub()">
						<div class="form-group" id="d0">
							<textarea style="width: 100%; height: 400px;"
								class="form-control" name="name_in" id="intext"
								placeholder="请输入待进行词法分析的源程序" onblur="checkCon()"
						...
						<div class="form-group" id="d1">
							<input type="text" class="form-control" name="name_out"
								id="name_out" placeholder="输出文件名" onblur="checkName()"
								onfocus="focusName(this)" required> <span
								class="help-block " id="s1"></span>
						</div>
						<div class="form-group">
							<button type="submit"
								class="btn btn-block btn-primary register-btn">添加</button>
						</div>
					</form>
...
<script>
	...
	function checkCon() {
		var con = document.getElementById("intext");
		var n = con.value;
